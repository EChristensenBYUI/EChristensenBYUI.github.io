...
const apiURL="https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=ab1af1b162d4021b8b58055befd97b83&units=imperial";
fetch(apiURL) 
  ...
  const apiURLforecast="https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=ab1af1b162d4021b8b58055befd97b83&units=imperial";
            ...
            fetch(requestURL)
              ...
              .then(function (jsonObject) {
               ...
               // console.table(jsonObject);  // temporary checking for valid response and data parsing
                ...
                events.textContent = towns[0].events[0];
                ...
                document.querySelector('#events').appendChild(card).setAttribute('class', 'eventflex');
